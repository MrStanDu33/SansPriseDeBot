...
class Logger {
   ...
   * @static
   *
   * @description Prints given info messages to the console and to
   ...
   * @static
   *
   * @description Prints given warning messages to the console and to
   ...
   * @static
   *
   * @description Prints given error messages to the console and to
